...
const data = [
    ...
    { id: 5, title: 'Have dental appointment', order: 5, completed: false, createdOn: new Date() },
    { id: 5, title: 'Have practice homework', order: 5, completed: false, createdOn: new Date() },
];
